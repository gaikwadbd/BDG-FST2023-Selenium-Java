...
public class PracticeTest29 {


        private String handAsString;

        public PracticeTest29(String hand) {
            handAsString = hand;
        }

        public Boolean isGreaterThan(PracticeTest29 hand1, PracticeTest29 hand2) {
        ...
        public static void testHand1IsGreaterThanHand2(String hand1AsString,String hand2AsString,Boolean expectedResult) {
            ...
            PracticeTest29 hand1 = new PracticeTest29(hand1AsString);
            PracticeTest29 hand2 = new PracticeTest29(hand2AsString);
