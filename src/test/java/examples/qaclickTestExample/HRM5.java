...
public class HRM5 {
  ...
  public void f(String sUsername, String sPassword) throws InterruptedException {
		...
		Select Usyss = new Select(driver.findElement(By.id("personal_cmbNation")));
		Usyss.selectByVisibleText("Indian");
		driver.findElement(By.id("personal_DOB")).sendKeys("");
        for (int i=0;i<10;i++){
    		driver.findElement(By.id("personal_DOB")).sendKeys(Keys.BACK_SPACE);
        }
