...
public class ParallelTestClass {
        ...
        // Check thread count in console output to see how these test methods use
        // multiple threads to execute in parallel, rerun and verify again
        // We are running tests from Parallel_Classes_Tests1 and Parallel_Classes_Tests2
        @Test
